...
class Flow(CreatedMixin,
    ...
    process_obj = models.ForeignKey(ContentType, on_delete="CASCADE")
    ...
    def save(self, *args, **kwargs):
        ...
        elif Proceeding.objects.filter(flow=self):
...
class FlowNode(CreatedMixin,
    ...
    flow = models.ForeignKey(Flow, on_delete="CASCADE", db_column='flow_id')
    ...
    forward_node = models.ForeignKey('self', null=True, on_delete="CASCADE", related_name="backword")
    backward_node = models.ForeignKey('self', null=True, on_delete="CASCADE", related_name="forward")
